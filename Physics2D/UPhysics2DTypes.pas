...
type
   ...
   TPointF = packed record
      ...
      procedure SetValue(ax, ay: TPointFloat); {$IFDEF INLINE_AVAIL}inline;{$ENDIF}
      {$ENDIF}
   end;
...
type
   ...
   TVector2 = record
      ...
      procedure SetValue(ax, ay: PhysicsFloat); {$IFDEF INLINE_AVAIL}inline;{$ENDIF}
      procedure SetLength(value: PhysicsFloat); {$IFDEF INLINE_AVAIL}inline;{$ENDIF}

      class function From(const ax, ay: PhysicsFloat): TVector2; static; {$IFDEF INLINE_AVAIL}inline;{$ENDIF}
      // Operators
...
procedure TPointF.SetValue(ax, ay: TPointFloat);
begin
   Self.x := ax;
   Self.y := ay;
end;
...
procedure TVector2.SetValue(ax, ay: PhysicsFloat);
begin
   Self.x := ax;
   Self.y := ay;
end;
...
class function TVector2.From(const ax, ay: PhysicsFloat): TVector2;
begin
   Result.x := ax;
   Result.y := ay;
end;
